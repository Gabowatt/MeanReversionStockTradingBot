...
namespace SimpleMeanReversionStockTradingBot
{
    class MeanReversionPaperOnly
    {
        private string API_KEY = "PKWX6B5K3V6BC65JUULT";
        private string API_SECRET = "TuXbICl5EPZZNkgqJJ9pdxRhDeL5yZGEH0LdkrSd";
